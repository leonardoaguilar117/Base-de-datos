        ...
        <div class="login">
            <form class="form_main" method="POST">
                ...
                <div class="inputContainer">
                    ...
                    <input placeholder="Usuario" id="username" class="inputField" type="text" name="Usuario">
                </div>
                ...
                <button type="submit" id="button" name="registrar">Ingresar</button>
            </form>
