...
if (isset($_POST["Enviar"])) {
    ...
    if (strlen($_POST["NombreGuit"]) >= 1 && strlen($_POST["Marca"]) >= 1) {
       
        $nombreGuitarra = $_POST["NombreGuit"];
        ...
        $query1 = "INSERT INTO guitarras(numCuerdas, Pastillas,Madera) 
        ...
        VALUES ('$nombreGuitarra','$marca','$stock','$id_proveedor','$precioCompra','$precioVenta')";
